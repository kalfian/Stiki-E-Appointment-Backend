                    ...
                    <ul class="list-unstyled list-unstyled-border">
                        <li class="media">
                            <img class="rounded-circle mr-3" width="50"
                                src="http://localhost:8001/img/avatar/avatar-1.png" alt="avatar">
                        ...
                        <li class="media">
                            <img class="rounded-circle mr-3" width="50"
                                src="http://localhost:8001/img/avatar/avatar-2.png" alt="avatar">
                            <div class="media-body">
                        ...
                        <li class="media">
                            <img class="rounded-circle mr-3" width="50"
                                src="http://localhost:8001/img/avatar/avatar-3.png" alt="avatar">
                            <div class="media-body">
                        ...
                        <li class="media">
                            <img class="rounded-circle mr-3" width="50"
                                src="http://localhost:8001/img/avatar/avatar-4.png" alt="avatar">
                            <div class="media-body">
                    ...
                    <div class="row pb-2">
                        <div class="col-6 col-sm-3 col-lg-3 mb-md-0 mb-4">
                            <div class="avatar-item mb-0">
                                <img alt="image" src="http://localhost:8001/img/avatar/avatar-5.png"
                        ...
                        <div class="col-6 col-sm-3 col-lg-3 mb-md-0 mb-4">
                            <div class="avatar-item mb-0">
                                <img alt="image" src="http://localhost:8001/img/avatar/avatar-4.png"
                        ...
                        <div class="col-6 col-sm-3 col-lg-3 mb-md-0 mb-4">
                            <div class="avatar-item mb-0">
                                <img alt="image" src="http://localhost:8001/img/avatar/avatar-2.png"
                        ...
                        <div class="summary-item">
                            ...
                            <ul class="list-unstyled list-unstyled-border">
                                <li class="media">
                                    <a href="#">
                                        <img class="mr-3 rounded" width="50"
                                            src="http://localhost:8001/img/products/product-1-50.png"
                                            alt="product">
                                    </a>
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <a href="#">
                                        <img class="mr-3 rounded" width="50"
                                            src="http://localhost:8001/img/products/product-2-50.png"
                                            alt="product">
                                    </a>
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <a href="#">
                                        <img class="mr-3 rounded" width="50"
                                            src="http://localhost:8001/img/products/product-3-50.png"
                                            alt="product">
                                    </a>
                                    <div class="media-body">
                ...
                <div class="card-body">
                    <ul class="list-unstyled list-unstyled-border">
                        ...
                        <li class="media">
                            ...
                            <img class="rounded-circle mr-3" width="50"
                                src="http://localhost:8001/img/avatar/avatar-5.png" alt="avatar">
                            <div class="media-body">
                        ...
                        <li class="media">
                            ...
                            <img class="rounded-circle mr-3" width="50"
                                src="http://localhost:8001/img/avatar/avatar-2.png" alt="avatar">
                            <div class="media-body">
                                <div class="badge badge-pill badge-warning float-right mb-1">Progress
                                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="font-weight-600"><img
                                                src="http://localhost:8001/img/avatar/avatar-1.png"
