...
<li class="breadcrumb-item"><a href="{{ route('admin.lectures.show', $lecture->id) }}">{{ $lecture->name }}</a></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ route('admin.lectures.update') }}" method="POST">
                            ...
                            <button class="btn btn-primary float-right" type="submit">Update Lecture</button>
                        </form>
                    </div>
                </div>
            </div>
